...
public interface EquipmentMapper {
	...
	Integer updateQueryReply(@Param("macAddress") String macAddress,@Param("queryToken") String queryToken,@Param("replyToken") String replyToken);
	
	//根据proId更新激活状态、激活时间
	Integer updateActStatus(@Param("proId") Integer proId,@Param("actStatus") Integer actStatus,@Param("actEndTime") String actEndTime);
	
	//更新平板状态
	Integer updateTableStauts(@Param("proId") Integer proId,@Param("tableStatus") Integer tableStatus,@Param("occupier") String occupier)throws Exception;
	...
	// 设置区域码
	int setRegionCode(@Param("macAddress") String macAddress, @Param("regionCode") String regionCode,@Param("country") String country,@Param("region") String region)throws Exception;

	// 设置/改修管理密码
	int updateAdminCode(@Param("proId") Integer proId, @Param("adminCode") String adminCode) throws Exception;

	// 设置/修改密保问题
	int updateProblem(@Param("proId") Integer proId,@Param("problem") String problem,
			@Param("answer") String answer) throws Exception;

	// 设置/修改密保手机
	int updateProPhone(@Param("proId") Integer proId, @Param("proPhone") String proPhone,@Param("countryCode") String countryCode) throws Exception;
	...
	// 修改管理密码状态
	int updateAdminCodeStatus(@Param("proId") Integer proId, @Param("adminPwdSwitch") Integer adminPwdSwitch) throws Exception;
	...
	int doNotDisturbUpdate(@Param("proId") Integer proId, @Param("doNotDisturb") Integer doNotDisturb,
			@Param("disturbFromTime") String disturbFromTime, @Param("distrubToTime") String distrubToTime) throws Exception;
