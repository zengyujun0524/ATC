 ...
 */
package com.aura.springboot.utils.apns.model;
...
//			apsObj.put("alert", getAlert());
			...
			alertObj.put("title", getAlert());
			
//			if ("chatMsg".equals(alert)) {
//				alertObj.put("body", "New message notification, please check.");
//
//			}else if ("bbsMsg".equals(alert)) {
//				alertObj.put("body", "BBS has been updated, please check.");
//
//			}
...
//		sb.append("{\"type\":\"famchat message\",\"userId\":\"137768618851443\",\"aps\":{\"sound\":\"default\",\"badge\":1,\"alert\":");
//		sb.append("{\"body\":\"New message notification, Please check.\",\"title\":\"New message\"}");
//		sb.append("}}");
		
//		Log.e("123", "result***==========>"+result);
//		Log.e("123", "sb***==========>"+sb.toString());
//		return sb.toString();
