...
public enum ResultCode {
	...
	USERID_NULL(20026, "User ID doesn't exist"),  
	...
	REGISTERPHONEANDSENDPHONE_DIFF(20031, "The registered phone number doesn't match the phone number that receive the SMS."),
