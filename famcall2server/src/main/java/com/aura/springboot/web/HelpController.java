...
public class HelpController {
	...
	@ApiImplicitParams({
			...
			@ApiImplicitParam(name = "appPcgName", value = "项目包名", dataType = "String", paramType = "query") })
	public ResponseResult userMacAddressRegister(String language, String appPcgName) throws Exception {
		if (language == null || StringUtils.isEmpty(language)) {
			return ResponseResult.failure(ResultCode.MACADDRESS_NULL);
		}
		return helpService.selectUserManual(language, appPcgName);
	}
