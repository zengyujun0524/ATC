...
public class EquipmentController {
	...
	public ResponseResult insertEquipment(String macAddress, String proNum, String proVersion, String proSysVersion,
			String firmwareSysVersion, String adminPwdSwitch, String activationTime, String appTypeId,String pushToken,Integer sysType) throws Exception {
		// 非空判断传入信息
...
//	}
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "macAddress", value = "mac地址", dataType = "String", paramType = "query") })
	public ResponseResult selectEquByMac(String macAddress) throws Exception {
		// 非空判断传入信息
		if (macAddress == null || StringUtils.isEmpty(macAddress)) {
			return ResponseResult.failure(ResultCode.MACADDRESS_NULL);
		}
	
		return equipmentService.selectEquByMac(macAddress);
	}
	...
	public ResponseResult setRegionCode(String macAddress, String regionCode,String country,String region) throws Exception {
		// 非空判断传入信息
		if (macAddress == null || StringUtils.isEmpty(macAddress)) {
			return ResponseResult.failure(ResultCode.MACADDRESS_NULL);
		}
...
//		}
	...
	public ResponseResult updateAdminCodeByOldAPwd(String macAddress,String adminCode,String oldadminCode) throws Exception {
		// 非空判断传入信息
		if (macAddress == null || StringUtils.isEmpty(macAddress)) {
			return ResponseResult.failure(ResultCode.MACADDRESS_NULL);
		}
	...
	@ApiImplicitParams({
			...
			@ApiImplicitParam(name = "registerCode", value = "短信注册码", dataType = "int", paramType = "query") })
	public ResponseResult updateProPhone(String macAddress, String proPhone,String countryCode, Integer registerCode) throws Exception {
		Long date = UserController.date;			//获取发送短信的时间
		Integer random = UserController.random;	//获取发送的验证码
