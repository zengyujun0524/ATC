...
public interface HistoryMapper {
	...
	// 更新同一手机最近登录的时间
	Integer updateHisInfo(@Param("historyId") Integer historyId, @Param("lastLogonTime") String lastLogonTime)
			throws Exception;
	...
	// 查看最后一个登录的设备标识
	History lastSnName(@Param("userId") Integer userId) throws Exception;

	// 通过设备标识查询上一次登录的userId
	History selectUserIdBySnNum(@Param("snNum") String snNum) throws Exception;
