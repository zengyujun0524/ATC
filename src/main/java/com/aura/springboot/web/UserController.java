...
public class UserController {
	...
	@ApiImplicitParams({
			...
			@ApiImplicitParam(name = "bssId", value = "路由器唯一标识", dataType = "int", paramType = "query"),
			@ApiImplicitParam(name = "ssId", value = "路由器名称", dataType = "int", paramType = "query"),
	...
	public ResponseResult userPhoneRegister(String phoneModel, String countryCode, String phone, String password,
			Integer registerCode, Integer appTypeId, String snNum, Integer sysType, String ssId, String bssId,
			String problem, String answer) throws Exception {
		// 非空判断传入信息
...
//        开始注册
		...
		return userService.registerPhone(user, snNum, bssId, ssId, problem, answer);
	}
...
//		log.info("json 格式--------------------------------------" + ss);
//		String result = Client.doPostJson("http://192.168.1.168:8080/rainbowchat_pro/rest_post", ss);
...
//	}
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "phone", value = "手机号", dataType = "String", paramType = "query"),
			...
			@ApiImplicitParam(name = "snNum", value = "登录标识", dataType = "String", paramType = "query"),
			@ApiImplicitParam(name = "sysType", value = "系统型号（0：安卓、1：苹果）", dataType = "int", paramType = "query"),
			@ApiImplicitParam(name = "bssId", value = "路由器唯一标识", dataType = "String", paramType = "query"),
	...
	public ResponseResult phoneLoginUp(String phone, String password, String countryCode, String phoneModel,
		...
		return userService.phoneLoginUp(phone, password, countryCode, phoneModel, snNum, sysType, bssId, ssId);
	}
	...
	@ApiOperation(value = "手机用户登录二次", notes = "根据手机号码，国家码和密码手机用户登录")
	@ApiImplicitParams({ @ApiImplicitParam(name = "phone", value = "手机号", dataType = "String", paramType = "query"),
			@ApiImplicitParam(name = "password", value = "密码", dataType = "String", paramType = "query"),
			@ApiImplicitParam(name = "countryCode", value = "国家码", dataType = "String", paramType = "query"),
			@ApiImplicitParam(name = "phoneModel", value = "手机型号", dataType = "String", paramType = "query"),
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/updateUserIpv4", method = RequestMethod.POST)
	...
	public ResponseResult updateUserIpv4(String imConnect, String bssId, String ssId, HttpServletRequest request)
		...
		return userService.updateUserIpv4(imConnect, bssId, ssId, request);
	}
...
//           重设密码
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/clearPushNews", method = RequestMethod.POST)
	@ApiOperation(value = "推送清零", notes = "推送清零")
	@ApiImplicitParams({ @ApiImplicitParam(name = "userId", value = "用户id", dataType = "int", paramType = "query") })
	public ResponseResult clearPushNews(Integer userId) throws Exception {
		if (userId == null) {
			return ResponseResult.failure(ResultCode.USERID_NULL);
		}
		return userService.clearPushNews(userId);
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/insertSecuityQuestion", method = RequestMethod.POST)
	@ApiOperation(value = "添加密保问题", notes = "添加密保问题")
	@ApiImplicitParams({ @ApiImplicitParam(name = "userId", value = "用户id", dataType = "int", paramType = "query"),
			@ApiImplicitParam(name = "problem", value = "密保问题", dataType = "String", paramType = "query"),
			@ApiImplicitParam(name = "answer", value = "密保答案", dataType = "String", paramType = "query") })
	public ResponseResult insertSecuityQuestion(Integer userId, String problem, String answer) throws Exception {
		if (userId == null) {
			return ResponseResult.failure(ResultCode.USERID_NULL);
		}
		Security security = new Security(userId, problem, answer);
		return userService.insertSecuityQuestion(security);
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/selectSecuityQuestion", method = RequestMethod.POST)
	@ApiOperation(value = "查询密保问题", notes = "查询密保问题")
	@ApiImplicitParams({ @ApiImplicitParam(name = "phone", value = "电话号码", dataType = "String", paramType = "query") })
	public ResponseResult selectSecuityQuestion(String phone) throws Exception {
		if (phone == null) {
			return ResponseResult.failure(ResultCode.PHONE_NULL);
		}

		return userService.selectSecuityQuestion(phone);
	}
	...
	public ResponseResult changePassword(String phone, String newPwd) throws Exception {
		if (phone == null) {
			return ResponseResult.failure(ResultCode.PHONE_NULL);
		}
		return userService.changePassword(phone, newPwd);
	}
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "userId", value = "用户ID", dataType = "int", paramType = "query"),
			@ApiImplicitParam(name = "friendsId", value = "好友ID", dataType = "String", paramType = "query"),
			@ApiImplicitParam(name = "friendPhone", value = "好友电话", dataType = "String", paramType = "query"),
			@ApiImplicitParam(name = "friendName", value = "好友姓名", dataType = "String", paramType = "query"),
			@ApiImplicitParam(name = "photo", value = "头像路径", dataType = "String", paramType = "query") })
	public ResponseResult addFriendRequest(Integer userId, Integer friendsId, String friendPhone, String friendName,
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/updateSecuityQuestion", method = RequestMethod.POST)
	@ApiOperation(value = "更新密保问题", notes = "更新密保问题")
	@ApiImplicitParams({ @ApiImplicitParam(name = "userId", value = "用户id", dataType = "int", paramType = "query"),
			@ApiImplicitParam(name = "problem", value = "密保问题", dataType = "String", paramType = "query"),
			@ApiImplicitParam(name = "answer", value = "密保答案", dataType = "String", paramType = "query") })
	public ResponseResult updateSecuityQuestion(int userId, String problem, String answer) throws Exception {
		...
		return userService.updateSecuityQuestion(security);
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/dontDisturb", method = RequestMethod.POST)
	@ApiOperation(value = "设置免打扰", notes = "设置免打扰")
	@ApiImplicitParams({ @ApiImplicitParam(name = "userId", value = "用户id", dataType = "int", paramType = "query"),
			@ApiImplicitParam(name = "ringTone", value = "铃声", dataType = "String", paramType = "query"),
			@ApiImplicitParam(name = "control", value = "是否开启免打扰（0：关闭，1：打开）", dataType = "int", paramType = "query") })
	public ResponseResult dontDisturb(Integer userId, String ringTone, Integer control) throws Exception {
		if (userId > 0) {
			return userService.dontDisturb(userId, ringTone, control);
		}
		return ResponseResult.failure(ResultCode.USERID_NULL);
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/selectDisturb", method = RequestMethod.POST)
	@ApiOperation(value = "查询是否开启免打扰", notes = "查询是否开启免打扰")
	@ApiImplicitParams({ @ApiImplicitParam(name = "userId", value = "用户id", dataType = "int", paramType = "query") })
	public ResponseResult selectDisturb(int userId) throws Exception {
		if (userId > 0) {
			return userService.selectDisturb(userId);
		}
		return ResponseResult.failure(ResultCode.USERID_NULL);
	}
