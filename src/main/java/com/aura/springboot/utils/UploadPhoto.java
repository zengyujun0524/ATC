...
public class UploadPhoto {
	...
	public static String upload(MultipartFile file, String folder, Integer userId) throws Exception {
		...
		if (!file.isEmpty()) {
			...
			// 这个路径是服务器上tomcat的路径 自己整个 服务器
			// /data0/mccree/tomcat/tomcat8/webapps 阿里云
			// /home/carry/tomcat/tomcat8/webapps 222内部服务器
			Path path = Paths.get("/data0/mccree/tomcat/tomcat8/webapps").resolve(folder);
		...
		// 图片请求地址 http://192.168.1.222:8090/ + fileName
		// http://47.75.47.133:8090/images/2.png
		String photoPath = "http://47.75.47.133:8090/" + folder + "/" + fileName;
		return photoPath;
