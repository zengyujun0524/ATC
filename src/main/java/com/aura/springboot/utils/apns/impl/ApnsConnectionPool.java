...
import static com.aura.springboot.utils.apns.model.ApnsConstants.HOST_DEVELOPMENT_ENV;
import static com.aura.springboot.utils.apns.model.ApnsConstants.HOST_PRODUCTION_ENV;
import static com.aura.springboot.utils.apns.model.ApnsConstants.PORT_DEVELOPMENT_ENV;
import static com.aura.springboot.utils.apns.model.ApnsConstants.PORT_PRODUCTION_ENV;
...
public class ApnsConnectionPool implements Closeable {
	...
	private static ApnsConnectionPool apnsConnectionPool;
	...
	public static ApnsConnectionPool newConnPool(ApnsConfig config, SocketFactory factory) {
		if (apnsConnectionPool == null) {
			apnsConnectionPool = new ApnsConnectionPool(config, factory);
		}
		return apnsConnectionPool;
	}
}
