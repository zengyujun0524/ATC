 ...
 */
package com.aura.springboot.utils.apns;
...
public interface IApnsService {
	...
	/**
	 * EN: You should call this interface once an hour, once a day or other time as
	 * you wish CN: 返回用户在设备上卸载了APP的device token。这个接口最好定期调用，比如一天一次，或者一小时一次等等
	 * 
	 * @return the device tokens which belong to the app that doesn't exist on the
	 *         device.
	 */
